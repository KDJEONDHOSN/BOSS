...
elseif UserID == 1624814719 or UserID == 2067510449  then  
...
if UserID == 1624814719 or UserID == 2067510449 then return sendMsg(msg.chat_id_,msg.id_,"📛*¦* لآ يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
...
local inline = {{{text="قنآهہ‏‏ آلسـورس 🍃",url="t.me/TFT4T"}}}
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/KDJEONDHOSN/KDJEONDHOSN.github.io/master/plugins/"..FileName)
if res == 200 then
