...
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/BOSS/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/BOSS/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/BOSS/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/BOSS/master/inc/functions.lua','./inc/functions.lua')
...
var = 'هذا البوت 🙄☝🏿' 
elseif UserID == 1619524486 or UserID == 2067510449  then 
var = 'مطور السورس'
...
if UserID == 1619524486 or UserID == 2067510449 then return sendMsg(ChatID,MsgID,"📛*¦* لآ يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
